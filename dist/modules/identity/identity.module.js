...
const login_use_case_1 = require("./core/application/use-cases/login.use-case");
const create_user_use_case_1 = require("./core/application/use-cases/create-user.use-case");
const refresh_token_use_case_1 = require("./core/application/use-cases/refresh-token.use-case");
...
exports.IdentityModule = IdentityModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [hello_world_use_case_1.HelloWorldUseCase, login_use_case_1.LoginUseCase, create_user_use_case_1.CreateUserUseCase, refresh_token_use_case_1.RefreshTokenUseCase],
    })
], IdentityModule);
